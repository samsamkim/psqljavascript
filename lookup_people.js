...
if(!nameInput){
  ...
  // client.query("SELECT COUNT(first_name) FROM famous_people")



// console.log("Found 2 person(s) by the name " + process.argv[2] + ": " +
// "- 1: Paul Rudd, born 1969-04-06" +
// "- 2: Paul Giamatti, born 1967-06-06");
// WHERE first_name = '" + nameInput + "' OR last_name = '" + nameInput +"'"